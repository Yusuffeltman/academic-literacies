...
export const unit01 = {
  ...
  html: () => `
    ...
    ${pathwayChallenge('u1', {
    title: 'Unit 1 Challenge Tracks',
    intro: 'Select your pathway and complete the listed challenge tasks for this unit.',
    supportedTasks: [
      'Define AI, generative AI, and hallucination in your own words.',
      'Verify one AI claim with one official or academic source.',
    ],
    coreTasks: [
      'Verify two AI claims and explain reliability differences.',
      'Write a short reflection linking AI limits to classroom practice.',
    ],
    advancedTasks: [
      'Compare two conflicting AI outputs and adjudicate evidence quality.',
      'Propose one classroom policy principle grounded in verified evidence.',
    ],
  })}
    ...
    ${essayMilestone('u1', {
    title: 'Essay Milestone (Unit 1)',
    target: 'Build the foundation: topic focus + first defensible claim sentence.',
    checklist: [
      'Write one claim sentence about AI and education in South Africa.',
      'Identify one source you can use later as essay evidence.',
      'State one question you still need to investigate in later units.',
    ],
  })}

    <h2>Self-Directed Learning Cycle</h2>
    <p>Set your learning contract for Unit 1, choose your challenge pathway, and capture evidence in your own words.</p>
    ${heutagogyCycle('u1-contract', {
    title: 'Unit 1 Learning Contract',
    prompt: 'Choose a realistic challenge level and define exactly how you will verify one AI claim this week.',
    context: 'Unit 1: AI literacy, hallucinations, verification habits',
    pathwayOptions: ['Supported: Verify one claim with tutor guidance', 'Core: Verify two claims using one official source each', 'Advanced: Verify two conflicting claims and explain reliability differences'],
    evidenceHint: 'Example evidence: source title + what was true/false + how you checked it.',
  })}

    ${portfolioEvidence('u1-pe', {
    title: 'AI Literacy Portfolio Artifact',
    target: 'Link to a verified AI output or a reflection on AI hallucination.',
  })}
